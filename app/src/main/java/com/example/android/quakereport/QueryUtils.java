...
/**
 * Created by nitish on 09-04-2017.
 */
   ...
   // private static final String SAMPLE_JSON_RESPONSE ="https://earthquake.usgs.gov/fdsnws/event/1/query?format=geojson&eventtype=earthquake&orderby=time&minmag=6&limit=10";
    ...
    private static String makeHttpRequest(URL url) throws IOException {
        ...
        try {
            ...
            if (urlConnection.getResponseCode() ==  HttpURLConnection.HTTP_OK) { // 200 == HttpURLConnection.HTTP_OK
    ...
    //public static ArrayList<Earthquake> extractEarthquakes() {
       ...
       //
        ...
        try {
            ...
            // create a json object from SAMPLE_JSON_Response STRING
           // JSONObject baseJsonResponse = new JSONObject(SAMPLE_JSON_RESPONSE);
            ...
            for(int i=0; i < earthquakeArray.length(); i++){
               ...
               // String magnitude = properties.getString("mag");
                ...
                Earthquake earthquake = new Earthquake(magnitude, place, timeInMilli, url);

               // Earthquake earthquake = new Earthquake(magnitude,place,timeInMilli);
